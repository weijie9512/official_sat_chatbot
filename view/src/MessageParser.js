// this does not handle flowchart logic.  This just considers 4-5 cases from the user input
...
class MessageParser {
  ...
  parse(message) {
    ...
    // otherwise
      ...
      // HERE IS NEW IF ELSE STATEMENT, UNRELATED TO TOPS
      ...
      if ((currentOptionToShow === "Continue" && message !== "Continue") ||
        ...
        // Here only prints OPEN TEXT
        console.log("Message:")
        console.log(message)
        console.log(choice_info)
        return this.actionProvider.sendRequest(choice_info);
      }
    }
