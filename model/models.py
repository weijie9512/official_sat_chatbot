...
class UserCommitment(db.Model):
    ...
    esa_action_count = db.Column(db.Integer(), default=0)
    esa_total_count = db.Column(db.Integer(), default=0)

    auc_understanding_action_count = db.Column(db.Integer(), default=0)
    auc_understanding_total_count = db.Column(db.Integer(), default=0)

    auc_commitments_action_count = db.Column(db.Integer(), default=0)
    auc_commitments_total_count = db.Column(db.Integer(), default=0)
    user_id = db.Column(db.Integer(), db.ForeignKey('user.id'))
